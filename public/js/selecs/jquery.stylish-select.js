...
(function($){
	...
	$.fn.sSelect = function(stylo_normal,stylos,options) {
		...
		return this.each(function(){
			...
			var opts = $.extend(defaults, options),
				...
				$containerDiv = $('<div class="newListSelected" tabindex="0" style="'+stylos+'"></div>'),
				$newUl = $('<ul class="newList" style="'+stylo_normal+'"></ul>'),
				itemIndex = -1,
				currentIndex = -1,
				keys = [],
				prevKey = false,
